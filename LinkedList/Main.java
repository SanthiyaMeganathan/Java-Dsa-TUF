...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // list6.printlist();
        // //to check check the function delete from anywhere:
        // //when the list is empty:
        // LinkedList list7 = new LinkedList();
        // list7.deleteFromAnyWhere();
        // //when the list as only one element:
        // LinkedList list8 = new LinkedList();
        // list8.insertAtEnd(2);
        // System.out.println("list before deleting");
        // list8.printlist();
        // System.out.println("");
        // System.out.println("list after deleting using delte from anywher when as list as only one element");
        // list8.deleteFromAnyWhere();
        // list8.printlist();
        // //when the list as many element:
        // LinkedList list9 = new LinkedList();
        // list9.insertAtEnd(2);
        // list9.insertAtEnd(4);
        // list9.insertAtEnd(6);
        // list9.insertAtEnd(8);
        // list9.insertAtEnd(10);
        // System.out.println("list before we dlete ");
        // list9.printlist();
        // System.out.println(" ");
        // System.out.println("LIST AFTRE DELETION");
        // list9.deleteFromAnyWhere();
        // list9.printlist();
        ...
        // list10.insertAtEnd(8);
        // list10.insertAtEnd(7);
        // list10.insertAtEnd(8);
        // list10.insertAtEnd(9);
        // list10.insertAtEnd(10);

        // list10.findTraget();

        //list to perform the updtae:
        //when the list is empty:

        // LinkedList list11 = new LinkedList();
        // list11.updateTheNode();

        //when list us not empty:

        LinkedList list12 = new LinkedList();
        list12.insertAtEnd(2);
        list12.insertAtEnd(4);
        list12.insertAtEnd(6);
        list12.insertAtEnd(8);
        ...
        System.out.println("The list before upadte");
        list12.printlist();
        
        System.out.println("");

        System.out.println("List after upadte");
        list12.updateTheNode();
